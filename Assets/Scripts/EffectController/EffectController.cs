...
// The effect controller is a singleton that can be called to perform functions related to gamefeel.
// These include stubs for hitstop, screenshake, and controller rumble.:
