...
public static class SoundManager
{
    ...
    // If actor is killed, audio source is lost with the actor.
    // ** It appears that the nature of the volume scale in this function is different from the volume in PlayClipAtPoint
    // ** Use when audio source needs to stick with actor for some time
